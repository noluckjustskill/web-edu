...
CREATE TABLE `information` (
	...
	`user_id` INT(255) UNSIGNED NULL DEFAULT NULL,
	`record_book` INT(255) UNSIGNED NULL DEFAULT NULL,
	`group_number` INT(255) UNSIGNED NULL DEFAULT NULL,
	...
	PRIMARY KEY (`id`),
	INDEX `FK_information_users` (`user_id`),
	CONSTRAINT `FK_information_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
)
COLLATE='utf8mb4_0900_ai_ci'
ENGINE=InnoDB
AUTO_INCREMENT=2
